...
function setup() {
    ...
    rSlider.style('margin', '5px');
    // slider for the value to increament angle by
    createSpan('Incremental slider ');
    angleIncSlider = createSlider(0,5,1, 0.1);
    angleIncSlider.mousePressed(function() { shouldIncrement = true; });
    // slider to specify angle directly
    createSpan('Angle slider ');
    angleSlider = createSlider(0,360, angle, 1);
    angleSlider.mousePressed(function() { shouldIncrement = false; });
    textSize(14);
